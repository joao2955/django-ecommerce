...
class Produto(models.Model):
    ...
    def resize_image(img, new_width=800):
        ...
        new_heigth = round((original_height * new_width) / original_width)
...
class Variacao(models.Model):
    ...
    produto = models.ForeignKey(Produto, on_delete=models.CASCADE, blank=True, null=True, related_name='variacoes_set')
